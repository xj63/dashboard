...
declare module 'vue' {
  export interface GlobalComponents {
    AMapContainerMarker: typeof import('./components/AMapContainerMarker.vue')['default']
    ...
    ButtonFullScreen: typeof import('./components/layout/ButtonFullScreen.vue')['default']
